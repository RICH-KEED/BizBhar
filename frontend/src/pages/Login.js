      ...
      <div className="flex w-full max-w-[1100px] bg-white shadow-2xl rounded-lg overflow-hidden min-h-[650px]">
        ...
        <div className="hidden lg:flex flex-col justify-between w-1/2 bg-primary p-12 text-white relative overflow-hidden">
          <div className="z-10">
            ...
            <h1 className="text-4xl font-extrabold leading-tight mb-6">Empowering Global Commerce</h1>
            <p className="text-lg text-blue-100 max-w-md leading-relaxed">
              The premier multi-vendor marketplace connecting verified buyers and suppliers across the globe.
            </p>
          </div>
          ...
          <div className="z-10">
            <div className="flex gap-4 mb-8">
              ...
              <div className="text-sm">
                ...
                <p className="text-blue-200">Scalable trade solutions</p>
              </div>
            </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 md:p-12 bg-white">
          <div className="w-full max-w-[380px]">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-500 text-sm">Access your business dashboard</p>
            </div>
